...
+ 下面的文字无形中成为学习资料的推荐，但是这里有一个问题，比如我对一个领域是入门，此时我选择一份资料，即使它客观上很差甚至有错误，我也能学到东西，同时无法识别出中间的错误。比如《C++ Primer Plus》，这是我的第一本C++语法说，后面再提到它我只评价是语言版本落后，但是实际上其中有很多知识是错误的，这是别人识别出来的，在我看的过程中是没有能力辨别的，这就导致我无法对学习资料做出正确的判断。
