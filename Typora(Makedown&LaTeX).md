...
+ 图像：
  ...
  插入图片Markdown语法代码：`![图片alt](https://cdn.jsdelivr.net/gh/zweix123/CS-notes-img@master/Software-Engineering/图片链接 "图片title")`。

  对应的HTML代码：`<img src="https://cdn.jsdelivr.net/gh/zweix123/CS-notes-img@master/Software-Engineering/图片链接" alt="图片alt" title="图片title">`
