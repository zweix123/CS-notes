...
## 函数对象
 ...
 ![](https://cdn.jsdelivr.net/gh/zweix123/CS-notes-img@master/Programing-Language/标准库函数对象.jpg)

## 类型转换

`<type_traits>`

 ![](https://cdn.jsdelivr.net/gh/zweix123/CS-notes-img@master/Programing-Language/标准类型转换模板及应用.png)
