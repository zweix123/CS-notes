...
+ 可重载的接口：<img src="https://cdn.jsdelivr.net/gh/zweix123/CS-notes-img@master/Programing-Language/动态内存接口.jpg" style="zoom:60%;" />
...
+ 头文件`<memory>`，名称空间`std`
  ...
  ​                 <img src="https://cdn.jsdelivr.net/gh/zweix123/CS-notes-img@master/Programing-Language/智能指针操作.jpg" style="zoom:80%;" />

  智能指针服务于动态内存的，不要用其管理普通变量，因为其默认delete销毁变量

+ 相关规范：<img src="https://cdn.jsdelivr.net/gh/zweix123/CS-notes-img@master/Programing-Language/智能指针规范.jpg" style="zoom: 80%;" />
...
![](https://cdn.jsdelivr.net/gh/zweix123/CS-notes-img@master/Programing-Language/weak_ptr操作.jpg)
...
+ 操作：<img src="https://cdn.jsdelivr.net/gh/zweix123/CS-notes-img@master/Programing-Language/unique_ptr构造.jpg" style="zoom:80%;" />

+ 管理数组：<img src="https://cdn.jsdelivr.net/gh/zweix123/CS-notes-img@master/Programing-Language/unique_ptr指向数组的.jpg" style="zoom:80%;" />
...
+ 说明：提供*类型感知*的内存分配的方法，是一种模板
 ...
 <img src="https://cdn.jsdelivr.net/gh/zweix123/CS-notes-img@master/Programing-Language/allocator类.jpg" style="zoom:80%;" />

 <img src="https://cdn.jsdelivr.net/gh/zweix123/CS-notes-img@master/Programing-Language/allocator伴随算法.jpg" style="zoom:80%;" />
