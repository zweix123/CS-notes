...
3. 按照等风疾大佬的视频配置下本机的VSCode， https://www.bilibili.com/video/BV1YG4y1v7uB/ ，我这里也有一些补充 https://github.com/zweix123/CS-notes/blob/master/Missing-Semester/VSCode.md
4. 配置VSCode关于C++的东西，其实这些包含于dfj的视频中，但是他使用的是ms C++插件，这里有clang的 https://github.com/zweix123/CS-notes/blob/master/Missing-Semester/VSCode.md#cc
5. 最后就是VSCode关于debug和cmake的配置，需要的插件也在dfj的视频中，对应的配置（其实也在dfj的视频中）在这 https://github.com/Codesire-Deng/TemplateRepoCxx/tree/main/.vscode 理论上直接copy过来就配完了。
