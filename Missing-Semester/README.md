Missing-Semester是MIT的一个计算机课程，学习学校不会教但是非常有用的工具。该目录本意也是该课程的笔记。在中科大“一生一芯”活动中，老师用了一节课的时间强调“工具是第一生产力”。在我个人的实践中，这句话也得到了印证。于是该目录的范围扩展出效率工具与工作流。相信我，它让我变得更强了。

+ 第一性原理：
    1. 从职业生涯的视角看，摸索一套自己工作流的投入产出比是极高的。
    2. 严格遵守奥卡姆剃刀原理：“如无必要、勿增实体”
        - 依照需求寻求工具，而非因工具能力而创造需求
        - GUI软件选择大而全的，CLI软件选择小而精的
